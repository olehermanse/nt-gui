...
describe('organization actions', () => {
  it('should handle different error message formats', async () => {
    ...
    const expectedActions = [
      ...
      { type: appActions.setSnackbar.type, payload: 'Deactivation request was sent successfully' },
  ...
  it('should handle support request sending', async () => {
    ...
    const expectedActions = [
      ...
      { type: appActions.setSnackbar.type, payload: 'Your request was sent successfully' },
